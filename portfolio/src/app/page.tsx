    ...
    <main className="min-h-screen pb-24">
      ...
      <section className="group w-full max-w-[960px] mx-auto px-5 md:px-4 mt-8 md:mt-12 animate-fade-in-up">
        ...
        <div className="mt-10 flex justify-center">
          ...
          >
            More About Me
            <span aria-hidden="true" className="transition-transform duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] group-hover/btn:translate-x-1">
              &rarr;
            </span>
          </a>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-8 lg:gap-16">
          ...
          <div className="group flex flex-col">
            ...
            <div className="flex flex-col gap-3">
              {/* Placeholder Track 1 */}
              <div className="flex items-center gap-4 p-3 rounded-xl hover:bg-black/[0.06] dark:hover:bg-white/[0.12] transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)]">
